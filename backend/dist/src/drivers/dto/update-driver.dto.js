...
__decorate([
    (0, swagger_2.ApiProperty)({ example: 95.5, required: false, description: 'Safety score from 0 to 100' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    (0, class_validator_1.Max)(100),
    __metadata("design:type", Number)
], UpdateDriverDto.prototype, "safetyScore", void 0);
__decorate([
    (0, swagger_2.ApiProperty)({ enum: client_1.DriverStatus, example: client_1.DriverStatus.AVAILABLE, required: false }),
    (0, class_validator_1.IsOptional)(),
