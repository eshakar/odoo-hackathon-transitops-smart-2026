...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new vehicle (Fleet Manager only)' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(client_1.Role.FLEET_MANAGER),
    (0, swagger_1.ApiOperation)({ summary: 'Update a vehicle (Fleet Manager only)' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.FLEET_MANAGER),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a vehicle (Fleet Manager only)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
